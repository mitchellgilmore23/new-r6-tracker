 ...
 * @Created: 16/05/2020
 * @repository: https://github.com/fabrice8/all-localstorage
 * 
*/
( function(){
	'use strict';
	...
	function Storage( options ){
		...
		const
		_this = this,
		_prefix = ( options.prefix || 'localstorage' )+':',
	  ...
	  this.flash = function( attribute, value ){
	  ...
	  this.flush = function( prefix ){
		...
		window.$ && window.$('[data-store]').each( function(){
			...
			if( !type || ![ 'flash', 'update' ].includes( type ) ) type = 'set'
	...
	*/
	...
	// Export Storage to the environment's global object
